...
#title-bar.mac .title-bar-buttons-container {
  display: flex;
...
#title-bar.mac .title-bar-buttons-container .bar-btn .mask {
  height: 100%;
  width: 100%;
  background-color: transparent;
...
#title-bar.mac .title-bar-buttons-container .bar-btn:nth-child(2n) {
  order: -1;
}

#title-bar.mac .title-bar-buttons-container:hover .mask {
  background-color: rgba(0, 0, 0, 0.4);
}

#title-bar.mac .title-bar-buttons-container .bar-btn:not(.inactive):first-child {
  background-color: #febc28;
}

#title-bar.mac .title-bar-buttons-container .bar-btn:not(.inactive):first-child:hover {
  background-color: #feb30a;
}

#title-bar.mac .title-bar-buttons-container .bar-btn:not(.inactive):nth-child(2n) {
  background-color: #01cc4e;
}

#title-bar.mac .title-bar-buttons-container .bar-btn:not(.inactive):nth-child(2n):hover {
  background-color: #01ae42;
}

#title-bar.mac .title-bar-buttons-container .bar-btn:not(.inactive).button-close {
  background-color: #ff5b5d;
}

#title-bar.mac .title-bar-buttons-container .bar-btn:not(.inactive).button-close:hover {
  background-color: #ff3c3f;
}

#title-bar.mac .button-close .mask {
...
#title-bar.mac .button-maximize .mask {
...
#title-bar.mac .button-unmaximize .mask {
...
#title-bar.mac .button-minimize .mask {
...
#title-bar.windows .title-bar-buttons-container {
  height: 100%;
  display: flex;
}

#title-bar.windows .title-bar-buttons-container .bar-btn {
  display: inline-block;
  -webkit-app-region: no-drag;
  height: 100%;
  width: 46px;
...
#title-bar.windows .title-bar-buttons-container .bar-btn .mask {
  height: 100%;
  width: 100%;
...
#title-bar.windows .title-bar-buttons-container .bar-btn.button-close .mask {
...
#title-bar.windows .title-bar-buttons-container .bar-btn .mask:hover {
  background-color: #ffffff!important;
}

#title-bar.windows .title-bar-buttons-container .bar-btn.button-unmaximize .mask {
...
#title-bar.windows .title-bar-buttons-container .bar-btn.button-maximize .mask {
...
#title-bar.windows .title-bar-buttons-container .bar-btn.button-minimize .mask {
...
#title-bar.windows .title-bar-buttons-container .bar-btn.button-close:hover {
  background-color: rgba(232, 17, 35, 0.9)!important;
}

#title-bar.windows .title-bar-buttons-container .bar-btn.inactive {
  background-color: transparent!important;
}

#title-bar.windows .title-bar-buttons-container .bar-btn.inactive .mask {
  opacity: .4;
}

#title-bar.windows .title-bar-buttons-container .mask {
}

#title-bar.windows.light .title-bar-buttons-container .mask {
  background-color: #333333;
}

#title-bar.windows.inactive .title-bar-buttons-container .mask {
  opacity: .7;
}

#title-bar.windows .title-bar-buttons-container .bar-btn:not(.inactive):hover {
