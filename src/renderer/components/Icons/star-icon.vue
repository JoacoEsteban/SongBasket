...
export default {
  ...
  mounted () {
    if (this.color[0] !== '#') this.colorLocal = '#' + this.color
    else this.colorLocal = this.color
  }
}
</script>

<style lang="scss" scoped>.iconito {
  width: 100%;
  height: 100%;
}</style>