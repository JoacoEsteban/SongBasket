...
export default {
  ...
  computed: {
    showReset () {
      return this.track && this.track.conversion && this.track.conversion.yt.length && (!this.track.selectionObj.isBestMatch || this.track.flags.selectionIsApplied)
    },
    showPause () {
